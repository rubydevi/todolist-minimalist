...
**To Do List** In this project, I will build a simple HTML list of To Do tasks. The list will be styled according to the specifications listed later in this lesson. This simple web page will be built using webpack and served by a webpack dev server.
...
```sh
  cd my-folder
  git clone git@github.com:rubydevi/book-collection-es6.git
  cd book-collection-es6
```
